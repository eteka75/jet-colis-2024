...
const DestinationImage: React.FC<DestinationImageType> = ({
  ...
  return (
    <article className="relative bg-accent shadow-sm  isolate flex flex-col justify-end overflow-hidden rounded-2xl  mx-auto group aspect-w-1 aspect-h-1 min-h-[200px]">
      <Image
        ...
        <div className="aspect-h-1_aspect-w-1 w-full overflow-hidden rounded-xl dark:bg-secondary/50 lg:aspect-none group-hover:opacity-75">
          {loading ? (
            <div style={{ display: 'flex', flexWrap: 'wrap' }}>
              <Skeleton className="h-[200px] bg-slate-300/50 items-center justify-center flex w-full shadow">
