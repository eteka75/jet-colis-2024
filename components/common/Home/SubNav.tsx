...
const SubNav = () => {
  ...
  return (
    <div className="bg-white border-b shadow-sm border-accent shadow-sms text-light z-0 dark:border-b dark:bg-background/80 _bg-opacity-90_backdrop-blur-3xl">
